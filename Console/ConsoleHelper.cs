namespace BonesClassLibrary;

public static class ConsoleHelper
{
    public static int Choices<T>(IList<T> array, string? msg = null, Func<T, string>? toString = null, bool forwardLoop = true)
    {
        int index = 0;
        if (msg != null)
            msg += "\n";
        ...
        {
            Console.Clear();
            Console.WriteLine($"{msg}SELECT OPTION (ARROW KEYS) WITH ENTER KEY:");
